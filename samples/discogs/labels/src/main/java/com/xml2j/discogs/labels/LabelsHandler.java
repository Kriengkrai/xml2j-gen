...
/**
 * Labels handler class.
 *
 * @see Labels
 */
public class LabelsHandler extends XMLFragmentHandler<Labels> {
	/**
	 * Proxy for LabelsHandler.
	 */
	static class Proxy extends HandlerProxy<Labels> {
		/**
		 * Allocator for LabelsHandler.
		 */
		private static class Allocator 
				extends HandlerProxy.Allocator<Labels> {			
			public XMLFragmentHandler<Labels> create(
					ParserTask task
					, XMLReader reader
	...
	private class LabelSetter implements DataSetter {
		/** data target. */
		private LabelsHandler pHandler = null;
		
		/**
		 * Constructor.
		 * @param pHandler parent that needs to be updated
		 */
		public LabelSetter(LabelsHandler pHandler) {

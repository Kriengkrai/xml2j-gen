 ...
 */
public class LabelsApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public LabelsApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public LabelsApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {

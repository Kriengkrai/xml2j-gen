package com.xml2j.discogs.labels.application;
...
import com.xml2j.discogs.labels.processor.LabelsProcessor;
...
public class LabelsApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(LabelsApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new LabelsApplicationTask(configuration);
			...
			LabelsProcessor p = new LabelsProcessor();

...
public class MastersType extends ComplexDataType {
	 ...
	 *  @serial
	 */	
	private List<MasterType_d0e5_a1> m_masterList = new ArrayList<MasterType_d0e5_a1>();
	
	/**
	 * Get the embedded list of Master elements.
	 * @return list of items.
	 */
	public List<MasterType_d0e5_a1> getMasters() {
		return m_masterList;
	}
	 ...
	 */
	void setMaster(MasterType_d0e5_a1 data) {
	...
	protected void printElements(Printer out) {
		...
		if (m_masterList != null) {
			for(MasterType_d0e5_a1 l_master : m_masterList) {
				l_master.print(out);
			}
		}	

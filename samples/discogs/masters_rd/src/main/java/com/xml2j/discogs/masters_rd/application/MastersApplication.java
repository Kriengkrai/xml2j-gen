package com.xml2j.discogs.masters_rd.application;
...
import com.xml2j.discogs.masters_rd.processor.MastersProcessor;
...
public class MastersApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(MastersApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new MastersApplicationTask(configuration);
			...
			app.prepareStart(inputStream, new MastersProcessor());
			app.processXML();

...
/**
 * VideoType_d0e47_a61 data class.
 *
 * This class provides getters and setters for embedded attributes and elements.
 * Any complex data structure can be navigated by using the element getter methods.
 * 
 */
public class VideoType_d0e47_a61 extends ComplexDataType {
	...
	/**
	 * Constructor for VideoType_d0e47_a61.
	 *
	 * @param elementName the name of the originating XML tag
	 * @param parent the parent data
	 */
	private VideoType_d0e47_a61(String elementName, ComplexDataType parent) {
	 ...
	 * The allocator is used by the framework to instantiate type VideoType_d0e47_a61.
	 */
	static class Allocator implements TypeAllocator<VideoType_d0e47_a61> {
		/**
		 * method for getting a new instance of type VideoType_d0e47_a61.
		 *
		 * @param elementName the name of the originating XML tag
		 * @param parent the parent data
		 * @return new instance
		 */
		public VideoType_d0e47_a61 newInstance(String elementName, ComplexDataType parent) {
			return new VideoType_d0e47_a61(elementName, parent);
		}
	}
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	VideoType_d0e47_a61 t = (VideoType_d0e47_a61)that;
...
//	}
	 ...
	 *  This method prints an XML fragment starting from videoType_d0e47_a61.
	 *

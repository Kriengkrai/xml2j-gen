...
/**
 * ArtistType_d0e17_a29 data class.
 *
 * This class provides getters and setters for embedded attributes and elements.
 * Any complex data structure can be navigated by using the element getter methods.
 * 
 */
public class ArtistType_d0e17_a29 extends ComplexDataType {
	...
	/**
	 * Constructor for ArtistType_d0e17_a29.
	 *
	 * @param elementName the name of the originating XML tag
	 * @param parent the parent data
	 */
	private ArtistType_d0e17_a29(String elementName, ComplexDataType parent) {
	 ...
	 * The allocator is used by the framework to instantiate type ArtistType_d0e17_a29.
	 */
	static class Allocator implements TypeAllocator<ArtistType_d0e17_a29> {
		/**
		 * method for getting a new instance of type ArtistType_d0e17_a29.
		 *
		 * @param elementName the name of the originating XML tag
		 * @param parent the parent data
		 * @return new instance
		 */
		public ArtistType_d0e17_a29 newInstance(String elementName, ComplexDataType parent) {
			return new ArtistType_d0e17_a29(elementName, parent);
		}
	}
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	ArtistType_d0e17_a29 t = (ArtistType_d0e17_a29)that;
	 ...
	 *  This method prints an XML fragment starting from artistType_d0e17_a29.
	 *

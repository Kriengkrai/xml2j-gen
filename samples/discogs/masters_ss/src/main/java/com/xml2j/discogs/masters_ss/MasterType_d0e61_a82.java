...
/**
 * MasterType_d0e61_a82 data class.
 *
 * This class provides getters and setters for embedded attributes and elements.
 * Any complex data structure can be navigated by using the element getter methods.
 * 
 */
public class MasterType_d0e61_a82 extends ComplexDataType {
	...
	/**
	 * Constructor for MasterType_d0e61_a82.
	 *
	 * @param elementName the name of the originating XML tag
	 * @param parent the parent data
	 */
	private MasterType_d0e61_a82(String elementName, ComplexDataType parent) {
	 ...
	 * The allocator is used by the framework to instantiate type MasterType_d0e61_a82.
	 */
	static class Allocator implements TypeAllocator<MasterType_d0e61_a82> {
		/**
		 * method for getting a new instance of type MasterType_d0e61_a82.
		 *
		 * @param elementName the name of the originating XML tag
		 * @param parent the parent data
		 * @return new instance
		 */
		public MasterType_d0e61_a82 newInstance(String elementName, ComplexDataType parent) {
			return new MasterType_d0e61_a82(elementName, parent);
		}
	}
	 ...
	 *  @serial
	 */	
	private ImagesType_d0e29_a42 m_images = null;
	
	/** element item for artists element. 
	 *  @serial
	 */	
	private ArtistsType_d0e33_a46 m_artists = null;
	
	/** element item for genres element. 
	 *  @serial
	 */	
	private GenresType_d0e37_a50 m_genres = null;
	
	/** element item for styles element. 
	 *  @serial
	 */	
	private StylesType_d0e41_a54 m_styles = null;
	 ...
	 *  @serial
	 */	
	private VideosType_d0e57_a78 m_videos = null;
	 ...
	 * @return the item.
	 */
	public ImagesType_d0e29_a42 getImages() {
		return m_images;
	}
	 ...
	 * @param data the item that needs to be added.
	 */
	void setImages(ImagesType_d0e29_a42 data) {
		m_images = data;
	}
	 ...
	 * @return the item.
	 */
	public ArtistsType_d0e33_a46 getArtists() {
		return m_artists;
	}
	 ...
	 * @param data the item that needs to be added.
	 */
	void setArtists(ArtistsType_d0e33_a46 data) {
		m_artists = data;
	}
	 ...
	 * @return the item.
	 */
	public GenresType_d0e37_a50 getGenres() {
		return m_genres;
	}
	 ...
	 * @param data the item that needs to be added.
	 */
	void setGenres(GenresType_d0e37_a50 data) {
		m_genres = data;
	}
	 ...
	 * @return the item.
	 */
	public StylesType_d0e41_a54 getStyles() {
		return m_styles;
	}
	 ...
	 * @param data the item that needs to be added.
	 */
	void setStyles(StylesType_d0e41_a54 data) {
		m_styles = data;
	}
	 ...
	 * @return the item.
	 */
	public VideosType_d0e57_a78 getVideos() {
		return m_videos;
	}
	 ...
	 * @param data the item that needs to be added.
	 */
	void setVideos(VideosType_d0e57_a78 data) {
		m_videos = data;
	}
	...
	public boolean equals(Object that) {  
		if (!super.equals(that))
	 	...
	 	MasterType_d0e61_a82 t = (MasterType_d0e61_a82)that;
...
//	}
	 ...
	 *  This method prints an XML fragment starting from masterType_d0e61_a82.
	 *

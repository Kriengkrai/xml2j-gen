...
/**
 * Artists handler class.
 *
 * @see Artists
 */
public class ArtistsHandler extends XMLFragmentHandler<Artists> {
	/**
	 * Proxy for ArtistsHandler.
	 */
	static class Proxy extends HandlerProxy<Artists> {
		/**
		 * Allocator for ArtistsHandler.
		 */
		private static class Allocator 
				extends HandlerProxy.Allocator<Artists> {			
			public XMLFragmentHandler<Artists> create(
					ParserTask task
					, XMLReader reader
	...
	private class ArtistSetter implements DataSetter {
		/** data target. */
		private ArtistsHandler pHandler = null;
		
		/**
		 * Constructor.
		 * @param pHandler parent that needs to be updated
		 */
		public ArtistSetter(ArtistsHandler pHandler) {
	 ...
	 */
	@Override 
	public Artists getData() {
		return (Artists)super.getData();
	}

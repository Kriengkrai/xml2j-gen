...
/**
 * ExtraartistsType handler class.
 *
 * @see ExtraartistsType
 */
public class ExtraartistsTypeHandler extends XMLFragmentHandler<ExtraartistsType> {
	/**
	 * Proxy for ExtraartistsTypeHandler.
	 */
	static class Proxy extends HandlerProxy<ExtraartistsType> {
		/**
		 * Allocator for ExtraartistsTypeHandler.
		 */
		private static class Allocator 
				extends HandlerProxy.Allocator<ExtraartistsType> {			
			public XMLFragmentHandler<ExtraartistsType> create(
					ParserTask task
					, XMLReader reader
					...
					, DataSetter setter
					, boolean doProcess) {
				return new ExtraartistsTypeHandler(
					task
					, reader
					, handler
					, elementName
					, ExtraartistsType.getAllocator()
					, setter
					, doProcess);
			}
		}
	...
	private class ArtistSetter implements DataSetter {
		/** data target. */
		private ExtraartistsTypeHandler pHandler = null;
		
		/**
		 * Constructor.
		 * @param pHandler parent that needs to be updated
		 */
		public ArtistSetter(ExtraartistsTypeHandler pHandler) {
	 ...
	 * @param doProcess indicates whether processing is active for this handler instance
	 */
	public ExtraartistsTypeHandler(
			ParserTask application
			, XMLReader reader
			, XMLFragmentHandler<?> parentH
			, String elementName
			, ExtraartistsType.Allocator allocator
			, DataSetter pSetter
			, boolean doProcess) {
	 ...
	 */
	@Override 
	public ExtraartistsType getData() {
		return (ExtraartistsType)super.getData();
	}

...
import com.xml2j.sepa2016.pain.handlers.CreditorPaymentActivationRequestStatusReportV05MessageHandler;
 ...
 */
public class CreditorPaymentActivationRequestStatusReportV05Runnable extends ParserRunnable {
	 ...
	 * @throws IOException 
	 */
	public CreditorPaymentActivationRequestStatusReportV05Runnable(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CreditorPaymentActivationRequestStatusReportV05Runnable(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new CreditorPaymentActivationRequestStatusReportV05MessageHandler(this, reader);
	}

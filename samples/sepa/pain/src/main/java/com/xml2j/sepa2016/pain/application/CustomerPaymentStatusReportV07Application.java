...
import com.xml2j.sepa2016.pain.runnable.CustomerPaymentStatusReportV07Runnable;

import com.xml2j.sepa2016.pain.processor.CustomerPaymentStatusReportV07Processor;
 ...
 */
public class CustomerPaymentStatusReportV07Application {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(CustomerPaymentStatusReportV07Application.class);
		...
		try {
			...
			ParserRunnable task = new CustomerPaymentStatusReportV07Runnable(configuration);
			...
			task.prepareStart(new FileInputStream(xml), new CustomerPaymentStatusReportV07Processor());
				
			// add the task to list of tasks
			manager.addTask("CustomerPaymentStatusReportV07Runnable", task);

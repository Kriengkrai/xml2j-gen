...
import com.xml2j.sepa2016.pain.runnable.CustomerCreditTransferInitiationV07Runnable;
import com.xml2j.sepa2016.repo.PainRepo;
import com.xml2j.sepa2016.pain.processor.CustomerCreditTransferInitiationV07Processor;
 ...
 */
public class CustomerCreditTransferInitiationV07Application {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ParserRunnable task = new CustomerCreditTransferInitiationV07Runnable(configuration);
			...
			task.prepareStart(new FileInputStream(xml), new CustomerCreditTransferInitiationV07Processor());
				
			// add the task to list of tasks
			manager.addTask("CustomerCreditTransferInitiationV07Runnable", task);

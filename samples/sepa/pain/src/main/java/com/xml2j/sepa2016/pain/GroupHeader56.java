...
public class GroupHeader56 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		...
		if (!Compare.equals(m_msgId, ((GroupHeader56)that).m_msgId))
			return false;
		
		if (!Compare.equals(m_creDtTm, ((GroupHeader56)that).m_creDtTm))
			return false;
		
		if (!Compare.equals(m_authstnList, ((GroupHeader56)that).m_authstnList))
			return false;
		
		if (!Compare.equals(m_nbOfTxs, ((GroupHeader56)that).m_nbOfTxs))
			return false;
		
		if (!Compare.equals(m_ctrlSum, ((GroupHeader56)that).m_ctrlSum))
			return false;
		
		if (!Compare.equals(m_grpRvsl, ((GroupHeader56)that).m_grpRvsl))
			return false;
		
		if (!Compare.equals(m_initgPty, ((GroupHeader56)that).m_initgPty))
			return false;
		
		if (!Compare.equals(m_fwdgAgt, ((GroupHeader56)that).m_fwdgAgt))
			return false;
		
		if (!Compare.equals(m_dbtrAgt, ((GroupHeader56)that).m_dbtrAgt))
			return false;
		
		if (!Compare.equals(m_cdtrAgt, ((GroupHeader56)that).m_cdtrAgt))
			return false;

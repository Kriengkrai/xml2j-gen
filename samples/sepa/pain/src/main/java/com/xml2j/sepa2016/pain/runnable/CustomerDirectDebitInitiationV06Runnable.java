...
import com.xml2j.sepa2016.pain.handlers.CustomerDirectDebitInitiationV06MessageHandler;
 ...
 */
public class CustomerDirectDebitInitiationV06Runnable extends ParserRunnable {
	 ...
	 * @throws IOException 
	 */
	public CustomerDirectDebitInitiationV06Runnable(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CustomerDirectDebitInitiationV06Runnable(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new CustomerDirectDebitInitiationV06MessageHandler(this, reader);
	}

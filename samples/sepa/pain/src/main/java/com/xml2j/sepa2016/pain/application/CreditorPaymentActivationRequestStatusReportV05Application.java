...
import com.xml2j.sepa2016.pain.runnable.CreditorPaymentActivationRequestStatusReportV05Runnable;

import com.xml2j.sepa2016.pain.processor.CreditorPaymentActivationRequestStatusReportV05Processor;
 ...
 */
public class CreditorPaymentActivationRequestStatusReportV05Application {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(CreditorPaymentActivationRequestStatusReportV05Application.class);
		...
		try {
			...
			ParserRunnable task = new CreditorPaymentActivationRequestStatusReportV05Runnable(configuration);
			...
			task.prepareStart(new FileInputStream(xml), new CreditorPaymentActivationRequestStatusReportV05Processor());
				
			// add the task to list of tasks
			manager.addTask("CreditorPaymentActivationRequestStatusReportV05Runnable", task);

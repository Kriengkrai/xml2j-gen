...
import com.xml2j.sepa2016.pain.handlers.CustomerCreditTransferInitiationV07MessageHandler;
 ...
 */
public class CustomerCreditTransferInitiationV07Runnable extends ParserRunnable {
	 ...
	 * @throws IOException 
	 */
	public CustomerCreditTransferInitiationV07Runnable(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CustomerCreditTransferInitiationV07Runnable(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {

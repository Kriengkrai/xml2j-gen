...
public class PaymentTransaction69 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		...
		if (!Compare.equals(m_stsId, ((PaymentTransaction69)that).m_stsId))
			return false;
		
		if (!Compare.equals(m_orgnlInstrId, ((PaymentTransaction69)that).m_orgnlInstrId))
			return false;
		
		if (!Compare.equals(m_orgnlEndToEndId, ((PaymentTransaction69)that).m_orgnlEndToEndId))
			return false;
		
		if (!Compare.equals(m_txSts, ((PaymentTransaction69)that).m_txSts))
			return false;
		
		if (!Compare.equals(m_stsRsnInfList, ((PaymentTransaction69)that).m_stsRsnInfList))
			return false;
		
		if (!Compare.equals(m_chrgsInfList, ((PaymentTransaction69)that).m_chrgsInfList))
			return false;
		
		if (!Compare.equals(m_accptncDtTm, ((PaymentTransaction69)that).m_accptncDtTm))
			return false;
		
		if (!Compare.equals(m_acctSvcrRef, ((PaymentTransaction69)that).m_acctSvcrRef))
			return false;
		
		if (!Compare.equals(m_clrSysRef, ((PaymentTransaction69)that).m_clrSysRef))
			return false;
		
		if (!Compare.equals(m_orgnlTxRef, ((PaymentTransaction69)that).m_orgnlTxRef))
			return false;
		
		if (!Compare.equals(m_splmtryDataList, ((PaymentTransaction69)that).m_splmtryDataList))
			return false;

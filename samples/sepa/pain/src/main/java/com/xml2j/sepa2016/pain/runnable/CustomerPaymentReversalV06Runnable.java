...
import com.xml2j.sepa2016.pain.handlers.CustomerPaymentReversalV06MessageHandler;
 ...
 */
public class CustomerPaymentReversalV06Runnable extends ParserRunnable {
	 ...
	 * @throws IOException 
	 */
	public CustomerPaymentReversalV06Runnable(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CustomerPaymentReversalV06Runnable(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new CustomerPaymentReversalV06MessageHandler(this, reader);
	}

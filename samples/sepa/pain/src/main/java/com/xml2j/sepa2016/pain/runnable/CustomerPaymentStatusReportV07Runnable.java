...
import com.xml2j.sepa2016.pain.handlers.CustomerPaymentStatusReportV07MessageHandler;
 ...
 */
public class CustomerPaymentStatusReportV07Runnable extends ParserRunnable {
	 ...
	 * @throws IOException 
	 */
	public CustomerPaymentStatusReportV07Runnable(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public CustomerPaymentStatusReportV07Runnable(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new CustomerPaymentStatusReportV07MessageHandler(this, reader);
	}

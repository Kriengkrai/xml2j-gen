...
import com.xml2j.sepa2016.pain.runnable.CustomerPaymentReversalV06Runnable;

import com.xml2j.sepa2016.pain.processor.CustomerPaymentReversalV06Processor;
 ...
 */
public class CustomerPaymentReversalV06Application {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(CustomerPaymentReversalV06Application.class);
		...
		try {
			...
			ParserRunnable task = new CustomerPaymentReversalV06Runnable(configuration);
			...
			task.prepareStart(new FileInputStream(xml), new CustomerPaymentReversalV06Processor());
				
			// add the task to list of tasks
			manager.addTask("CustomerPaymentReversalV06Runnable", task);

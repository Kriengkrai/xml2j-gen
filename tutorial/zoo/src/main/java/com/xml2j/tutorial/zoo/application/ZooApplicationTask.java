package com.xml2j.tutorial.zoo.application;
...
import com.xml2j.tutorial.zoo.handlers.ZooCollectionMessageHandler;
 ...
 */
public class ZooApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public ZooApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public ZooApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new ZooCollectionMessageHandler(this, reader);
	}

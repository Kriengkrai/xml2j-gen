...
import com.xml2j.tutorial.subst.processor.SubstProcessor;
...
public class SubstApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(SubstApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new SubstApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new SubstProcessor());
			app.processXML();

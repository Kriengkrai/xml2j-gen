package com.xml2j.tutorial.subst.application;
...
import com.xml2j.tutorial.subst.handlers.SubstMessageHandler;
 ...
 */
public class SubstApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public SubstApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public SubstApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new SubstMessageHandler(this, reader);
	}

package com.xml2j.tutorial.subst2.application;
...
import com.xml2j.tutorial.subst2.handlers.Subst2MessageHandler;
 ...
 */
public class Subst2ApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public Subst2ApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public Subst2ApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new Subst2MessageHandler(this, reader);
	}

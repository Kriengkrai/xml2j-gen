...
public class ContainerType4 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		...
		if (!Compare.equals(m_firstNameList, ((ContainerType4)that).m_firstNameList))
			return false;
		
		if (!Compare.equals(m_middleNameList, ((ContainerType4)that).m_middleNameList))
			return false;
		
		if (!Compare.equals(m_lastNameList, ((ContainerType4)that).m_lastNameList))
			return false;

...
import com.xml2j.tutorial.subst2.processor.Subst2Processor;
 ...
 */
public class Subst2Application {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(Subst2Application.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new Subst2ApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new Subst2Processor());
			app.processXML();

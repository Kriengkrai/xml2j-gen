...
public class ContainerType1 extends ComplexDataType {
	...
	public boolean equals(Object that) {  
		...
		if (!Compare.equals(m_firstNameList, ((ContainerType1)that).m_firstNameList))
			return false;
		
		if (!Compare.equals(m_middleNameList, ((ContainerType1)that).m_middleNameList))
			return false;
		
		if (!Compare.equals(m_lastNameList, ((ContainerType1)that).m_lastNameList))
			return false;

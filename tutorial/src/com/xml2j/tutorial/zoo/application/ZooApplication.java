...
import com.xml2j.tutorial.zoo.processor.ZooProcessor;
...
public class ZooApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(ZooApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new ZooApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new ZooProcessor());
			app.processXML();

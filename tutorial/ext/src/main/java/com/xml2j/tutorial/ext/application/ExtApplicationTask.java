...
import com.xml2j.tutorial.ext.handlers.ExtMessageHandler;
 ...
 */
public class ExtApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public ExtApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public ExtApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new ExtMessageHandler(this, reader);
	}

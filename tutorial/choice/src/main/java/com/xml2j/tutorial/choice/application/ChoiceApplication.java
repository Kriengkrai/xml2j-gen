...
import com.xml2j.tutorial.choice.processor.ChoiceProcessor;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			ParserTask app = new ChoiceApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new ChoiceProcessor());
			app.processXML();

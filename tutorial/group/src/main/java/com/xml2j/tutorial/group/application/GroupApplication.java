...
import com.xml2j.tutorial.group.processor.GroupProcessor;
...
public class GroupApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(GroupApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new GroupApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new GroupProcessor());
			app.processXML();

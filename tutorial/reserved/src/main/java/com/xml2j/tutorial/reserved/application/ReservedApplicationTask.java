package com.xml2j.tutorial.reserved.application;
...
import com.xml2j.tutorial.reserved.handlers.ReservedMessageHandler;
 ...
 */
public class ReservedApplicationTask extends ParserTask {
	 ...
	 * @throws IOException 
	 */
	public ReservedApplicationTask(ParserConfiguration configuration) 
	 ...
	 * @throws IOException 
	 */
	public ReservedApplicationTask(ParserConfiguration configuration, ErrorHandler errorHandler)
			throws SAXException, ParserConfigurationException, IOException {
	...
	protected MessageHandler getMessageHandler(XMLReader reader) {
		return new ReservedMessageHandler(this, reader);
	}

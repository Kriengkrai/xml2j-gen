...
import com.xml2j.tutorial.reserved.processor.ReservedProcessor;
...
public class ReservedApplication {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(ReservedApplication.class);
		...
		try {
			...
			*/
			...
			ParserTask app = new ReservedApplicationTask(configuration);
			...
			app.prepareStart( new FileInputStream(xml), new ReservedProcessor());
			app.processXML();
